...
public class PacienteController {
    ...
    public ResponseEntity<?> update(@PathVariable Long idPaciente, @RequestBody Paciente paciente) {
        try {
    ...
    public ResponseEntity<?> desativar(@PathVariable Long idPaciente, @RequestBody Paciente paciente) {
        try {
